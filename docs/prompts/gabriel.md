# 🦁 Profil Collaborateur : Gabriel (Lead Backend)
...
Au début de chaque session, Gabriel te fournira le `project_context.txt` et la `todo.md`.
1. Scanne la `todo.md`.
2. Identifie la tâche en cours (Cluster Gabriel).
3. Rappelle brièvement à Gabriel où vous en êtes.
4. Demande-lui s'il veut commencer l'Étape 1 sur la tâche suivante.
